...
mdconvert='/home/jamie/jm.software/GSA_schlitte/entropy_python/ana_scripts/mdconvert.py'
...
trjconv -f $1 -s $2 -b 0 -e $k -o trajout$k.xtc -n $5 <<EOF
3
EOF

trjconv -f $1 -s $2 -b 0 -e 0 -o topol$k.pdb -n $5 <<EOF
3
EOF
